...
# Importante revisar las librerías y la versión de python instalada, porque este código fue probado con Python 3.10 y las librerías skfuzzy y matplotlib.
# Y durante el proceso me dio errores relacionados con la versión de las librerías.
